    ...
    public byte[] serializeWalletExtension() {
        ...
        try {
            ...
            for (StoredClientChannel channel : mapChannels.values()) {
                ...
                checkState(channel.valueToMe.signum() >= 0 && channel.valueToMe.compareTo(containingWallet.getParams().getMaxMoney()) < 0);
                checkState(channel.refundFees.signum() >= 0 && channel.refundFees.compareTo(containingWallet.getParams().getMaxMoney()) < 0);
