 ...
 * <a href="https://github.com/bitcoinj/bips/blob/master/bip-0032.mediawiki">BIP 32 standard</a>, as implemented by
 * {@link io.mappum.altcoinj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link io.mappum.altcoinj.crypto.MnemonicCode},
 ...
 * {@link io.mappum.altcoinj.crypto.DeterministicKey#serializePubB58()}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link io.mappum.altcoinj.crypto.DeterministicKey#deserializeB58(io.mappum.altcoinj.crypto.DeterministicKey, String)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(io.mappum.altcoinj.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link io.mappum.altcoinj.crypto.DeterministicHierarchy} and
 * {@link io.mappum.altcoinj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
     ...
     * The returned key can be serialized and then passed into {@link #watch(io.mappum.altcoinj.crypto.DeterministicKey)}
