...
/**
 * <p>A KeyChain is a class that stores a collection of keys for a {@link io.mappum.altcoinj.core.Wallet}. Key chains
...
public interface KeyChain {
     ...
     *
     * <p>See the docs for {@link io.mappum.altcoinj.core.BloomFilter#BloomFilter(int, double, long)} for a brief
