...
/**
 * <p>A KeyChainGroup is used by the {@link io.mappum.altcoinj.core.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws io.mappum.altcoinj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link io.mappum.altcoinj.crypto.KeyCrypterScrypt}.
     *
     * @throws io.mappum.altcoinj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
