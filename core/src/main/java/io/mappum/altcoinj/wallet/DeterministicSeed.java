...
public class DeterministicSeed implements EncryptableItem {
    ...
    /**
     * Constructs a seed from a BIP 39 mnemonic code. See {@link io.mappum.altcoinj.crypto.MnemonicCode} for more
     ...
     *
     * @throws io.mappum.altcoinj.crypto.MnemonicException if check fails
     */
