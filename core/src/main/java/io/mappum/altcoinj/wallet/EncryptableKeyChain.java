...
public interface EncryptableKeyChain extends KeyChain {
     ...
     * {@link #toEncrypted(io.mappum.altcoinj.crypto.KeyCrypter, org.spongycastle.crypto.params.KeyParameter)} with
     * {@link io.mappum.altcoinj.crypto.KeyCrypterScrypt} as the crypter.
     *
     ...
     * {@link io.mappum.altcoinj.core.Wallet.SendRequest#aesKey} field before asking the wallet to build the send.
     *
