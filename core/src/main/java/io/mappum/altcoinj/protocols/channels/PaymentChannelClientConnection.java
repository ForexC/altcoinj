...
import io.mappum.altcoinj.net.NioClient;
...
public class PaymentChannelClientConnection {
     ...
     * connection is open. The server is requested to keep the channel open for {@link io.mappum.altcoinj.protocols.channels.PaymentChannelClient#DEFAULT_TIME_WINDOW}
