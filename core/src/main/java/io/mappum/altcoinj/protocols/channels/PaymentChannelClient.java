...
import io.mappum.altcoinj.protocols.channels.PaymentChannelCloseException.CloseReason;
...
public class PaymentChannelClient implements IPaymentChannelClient {
     ...
     *                   See {@link io.mappum.altcoinj.protocols.channels.IPaymentChannelClient.ClientConnection#acceptExpireTime(long)}
     * @param conn A callback listener which represents the connection to the server (forwards messages we generate to
     *             the server)
     */
     ...
     * {@link ClientConnection#destroyConnection(io.mappum.altcoinj.protocols.channels.PaymentChannelCloseException.CloseReason)} or
