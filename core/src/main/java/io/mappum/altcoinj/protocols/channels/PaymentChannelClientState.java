...
import io.mappum.altcoinj.wallet.AllowUnconfirmedCoinSelector;
 ...
 * You must then call {@link PaymentChannelClientState#storeChannelInWallet(io.mappum.altcoinj.core.Sha256Hash)} to store the refund transaction
...
public class PaymentChannelClientState {
     ...
     * overriding {@link PaymentChannelClientState#editContractSendRequest(io.mappum.altcoinj.core.Wallet.SendRequest)}.
     ...
     * later.
     *
     * @see PaymentChannelClientState#storeChannelInWallet(io.mappum.altcoinj.core.Sha256Hash)
     */
