...
import io.mappum.altcoinj.utils.BtcAutoFormat.Style;
import static io.mappum.altcoinj.utils.BtcAutoFormat.Style.*;
 ...
 * <code>"฿"</code>.
 *
 * <p>The denomination used when formatting will be either bitcoinj, millicoin
 ...
 * locale, a value of one bitcoinj might be formatted as <pre>฿1.00</pre> where a value
 ...
 * <code>1.0000 BTC</code>, or one bitcoinj, in millibitcoins, one shifts the decimal point
 ...
 * differently the same one-bitcoinj value:
 *
 * <blockquote><pre>
 ...
 * method.  This argument can be either a {@link io.mappum.altcoinj.core.Coin}-type object or a
 ...
 * @see          io.mappum.altcoinj.core.Coin
 */
...
public abstract class BtcFormat extends Format {
    ...
    /**
     * Formats a bitcoinj monetary value and returns an {@link java.text.AttributedCharacterIterator}.
    ...
    /**
     * Formats a bitcoinj value as a number and possibly a units indicator and appends the
    ...
    /**
     * Formats a bitcoinj value as a number and possibly a units indicator to a
    ...
    /**
     * Takes a bitcoinj monetary value that the client wants to format and returns the number of
    ...
    /**
     * Takes an object representing a bitcoinj quantity of any type the
    ...
    /**
      ...
      * {@link io.mappum.altcoinj.core.Coin} object that represents the parsed value.
      * @see java.text.NumberFormat */
    @Override
