...
import io.mappum.altcoinj.core.Monetary;
...
public final class MonetaryFormat {
    ...
    /**
     * Parse a human readable coin value to a {@link io.mappum.altcoinj.core.Coin} instance.
     * 
    ...
    /**
     * Parse a human readable fiat value to a {@link io.mappum.altcoinj.core.Fiat} instance.
     * 
     * @throws NumberFormatException
     *             if the string cannot be parsed for some reason
     */
