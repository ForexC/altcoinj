...
public interface BlockChainListener {
     ...
     * us via either {@link #receiveFromBlock(Transaction, StoredBlock, io.mappum.altcoinj.core.BlockChain.NewBlockType, int)}
     * or {@link #notifyTransactionIsInBlock(Sha256Hash, StoredBlock, io.mappum.altcoinj.core.BlockChain.NewBlockType, int)}.
