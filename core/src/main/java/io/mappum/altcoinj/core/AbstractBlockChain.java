 ...
 * the lightweight SPV mode, a {@link io.mappum.altcoinj.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link io.mappum.altcoinj.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to the
...
public abstract class AbstractBlockChain {
    ...
    private void checkDifficultyTransitions(StoredBlock storedPrev, Block nextBlock) throws BlockStoreException, VerificationException {
        checkState(lock.isHeldByCurrentThread());
        params.checkDifficulty(storedPrev, nextBlock, blockStore);
    }
