 ...
 * Note that an implementer is responsible for calling {@link PeerGroup#recalculateFastCatchupAndFilter(io.mappum.altcoinj.core.PeerGroup.FilterRecalculateMode)}
...
public interface PeerFilterProvider {
     ...
     * possible for the {@link io.mappum.altcoinj.net.FilterMerger} to request the counts of a bunch of providers
