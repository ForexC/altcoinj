...
import io.mappum.altcoinj.net.AbstractTimeoutHandler;
import io.mappum.altcoinj.net.MessageWriteTarget;
import io.mappum.altcoinj.net.StreamParser;
 ...
 * {@link io.mappum.altcoinj.net} classes and {@link Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamParser {
     ...
     * called automatically by {@link io.mappum.altcoinj.net.NioClient} or
     * {@link io.mappum.altcoinj.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
