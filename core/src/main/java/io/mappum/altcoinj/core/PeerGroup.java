...
import io.mappum.altcoinj.crypto.DRMWorkaround;
import io.mappum.altcoinj.net.BlockingClientManager;
import io.mappum.altcoinj.net.ClientConnectionManager;
import io.mappum.altcoinj.net.FilterMerger;
import io.mappum.altcoinj.net.NioClientManager;
import io.mappum.altcoinj.net.discovery.PeerDiscovery;
import io.mappum.altcoinj.net.discovery.PeerDiscoveryException;
import io.mappum.altcoinj.net.discovery.TorDiscovery;
import io.mappum.altcoinj.script.Script;
import io.mappum.altcoinj.utils.ExponentialBackoff;
...
public class PeerGroup extends AbstractExecutionThreadService implements TransactionBroadcaster {
     ...
     *         Use {@link io.mappum.altcoinj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link io.mappum.altcoinj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link io.mappum.altcoinj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link io.mappum.altcoinj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * times are available via {@link io.mappum.altcoinj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link io.mappum.altcoinj.core.Peer#ping()}.
     */
