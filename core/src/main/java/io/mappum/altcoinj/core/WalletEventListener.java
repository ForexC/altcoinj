...
import io.mappum.altcoinj.wallet.KeyChainEventListener;
...
public interface WalletEventListener extends KeyChainEventListener {
     ...
     * the object retrieved via {@link io.mappum.altcoinj.core.Transaction#getConfidence()}. It's safe to modify the
