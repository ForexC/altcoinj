...
import static io.mappum.altcoinj.core.Utils.*;
...
public class Transaction extends ChildMessage implements Serializable {
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, io.mappum.altcoinj.script.Script, ECKey, io.mappum.altcoinj.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], io.mappum.altcoinj.core.Transaction.SigHash, boolean)}
