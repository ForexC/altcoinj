 ...
 * {@link io.mappum.altcoinj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link io.mappum.altcoinj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
    ...
    private static class GetDataRequest {
        ...
        // a nasty hack that relies on the fact that bitcoinj-qt is single threaded and processes messages in order.
     ...
     * {@link io.mappum.altcoinj.net.NioClientManager#openConnection(java.net.SocketAddress, io.mappum.altcoinj.net.StreamParser)}
     * or
     * {@link io.mappum.altcoinj.net.NioClient#NioClient(java.net.SocketAddress, io.mappum.altcoinj.net.StreamParser, int)}.</p>
     *
    ...
    private void blockChainDownloadLocked(Sha256Hash toHash) {
        ...
        //
        //   https://en.bitcoinj.it/wiki/Protocol_specification#getblocks
        //
     ...
     * Once the pong is received the value returned by {@link io.mappum.altcoinj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link io.mappum.altcoinj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link io.mappum.altcoinj.core.Peer#ping()} has never
