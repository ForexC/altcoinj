...
import io.mappum.altcoinj.core.TransactionConfidence.ConfidenceType;
import io.mappum.altcoinj.crypto.*;
import io.mappum.altcoinj.params.UnitTestParams;
import io.mappum.altcoinj.script.Script;
import io.mappum.altcoinj.script.ScriptBuilder;
import io.mappum.altcoinj.script.ScriptChunk;
import io.mappum.altcoinj.signers.LocalTransactionSigner;
import io.mappum.altcoinj.signers.MissingSigResolutionSigner;
import io.mappum.altcoinj.signers.TransactionSigner;
import io.mappum.altcoinj.store.UnreadableWalletException;
import io.mappum.altcoinj.store.WalletProtobufSerializer;
import io.mappum.altcoinj.utils.BaseTaggableObject;
import io.mappum.altcoinj.utils.ExchangeRate;
import io.mappum.altcoinj.utils.ListenerRegistration;
import io.mappum.altcoinj.utils.Threading;
import io.mappum.altcoinj.wallet.*;
import io.mappum.altcoinj.wallet.Protos.Wallet.EncryptionType;
import io.mappum.altcoinj.wallet.WalletTransaction.Pool;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, io.mappum.altcoinj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject implements Serializable, BlockChainListener, PeerFilterProvider, KeyBag, TransactionBag {
     ...
     * {@link io.mappum.altcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(io.mappum.altcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link io.mappum.altcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(io.mappum.altcoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(io.mappum.altcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link io.mappum.altcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link io.mappum.altcoinj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link io.mappum.altcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(io.mappum.altcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link io.mappum.altcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(io.mappum.altcoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(io.mappum.altcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link io.mappum.altcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, io.mappum.altcoinj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link io.mappum.altcoinj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link io.mappum.altcoinj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link io.mappum.altcoinj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws io.mappum.altcoinj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(io.mappum.altcoinj.crypto.KeyCrypter,
     ...
     * {@link io.mappum.altcoinj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link io.mappum.altcoinj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link io.mappum.altcoinj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link io.mappum.altcoinj.signers.TransactionSigner.MissingSignatureException}
    ...
    public static class SendRequest {
         ...
         * (its value is ignored and set to {@link io.mappum.altcoinj.core.Wallet#getBalance()} - the fees required
        ...
        /**
         * If not null, the {@link io.mappum.altcoinj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
     ...
     */
    public void setTransactionBroadcaster(@Nullable io.mappum.altcoinj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws io.mappum.altcoinj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
     ...
     * {@link io.mappum.altcoinj.core.PeerFilterProvider} interface and generally should not be used directly by apps.
