...
public interface BlockStore {
     ...
     * can be arbitrarily expensive, you probably should use {@link io.mappum.altcoinj.core.BlockChain#getChainHead()}
     * or perhaps {@link io.mappum.altcoinj.core.BlockChain#getBestChainHeight()} which will run in constant time and
