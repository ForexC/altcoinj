...
package io.mappum.altcoinj.net.discovery;

import io.mappum.altcoinj.core.AddressFormatException;
import io.mappum.altcoinj.core.Base58;
...
public class IrcDiscovery implements PeerDiscovery {
     ...
     * disconnecting.
     *
     * @param channel The IRC channel to join, either "#bitcoinj" or "#bitcoinTEST3" for the production and test networks
     *                respectively.
     */
