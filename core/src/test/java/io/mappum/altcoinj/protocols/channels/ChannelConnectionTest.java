...
import io.mappum.altcoinj.testing.TestWithWallet;
import io.mappum.altcoinj.utils.Threading;
import io.mappum.altcoinj.wallet.WalletFiles;
...
import static io.mappum.altcoinj.protocols.channels.PaymentChannelCloseException.CloseReason;
import static io.mappum.altcoinj.testing.FakeTxBuilder.createFakeBlock;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        io.mappum.altcoinj.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
