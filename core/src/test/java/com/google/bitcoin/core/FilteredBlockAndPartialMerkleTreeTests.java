...
public class FilteredBlockAndPartialMerkleTreeTests extends TestWithPeerGroup {
    ...
    public void deserializeFilteredBlock() throws Exception {
        ...
        assertTrue(block.getBlockHeader().getHash().equals(new Hash("000000000000dab0130bbcc991d3d7ae6b81aa6f50a798888dfe62337458dc45")));
        
        // Check that the partial merkle tree is correct
        List<Hash> txesMatched = block.getTransactionHashes();
        assertTrue(txesMatched.size() == 1);
        assertTrue(txesMatched.contains(new Hash("63194f18be0af63f2c6bc9dc0f777cbefed3d9415c4af83f3ee3a3d669c00cb5")));
    }
    ...
    public void serializeDownloadBlockWithWallet() throws Exception {
        ...
        // Block 100001
        assertTrue(block.getHash().equals(new Hash("00000000000080b66c911bd5ba14a74260057311eaeb1982802f7010f1a9f090")));
        assertTrue(filteredBlock.getHash().equals(block.getHash()));
        
        List<Hash> txHashList = filteredBlock.getTransactionHashes();
        ...
        assertTrue(tx0.getHash().equals(new Hash("bb28a1a5b3a02e7657a81c38355d56c6f05e80b9219432e3352ddcfc3cb6304c")));
        ...
        assertTrue(tx1.getHash().equals(new Hash("fbde5d03b027d2b9ba4cf5d4fecab9a99864df2637b25ea4cbcb1796ff6550ca")));
        ...
        assertTrue(tx2.getHash().equals(new Hash("8131ffb0a2c945ecaf9b9063e59558784f9c3a74741ce6ae2a18d0571dac15bb")));
        ...
        assertTrue(tx3.getHash().equals(new Hash("c5abc61566dbb1c4bce5e1fda7b66bed22eb2130cea4b721690bc1488465abc9")));
        ...
        blockStore.setChainHead(blockStore.get(new Hash("000000000003ba27aa200b1cecaad478d2b00432346c3f1f3986da1afd33e506")));
