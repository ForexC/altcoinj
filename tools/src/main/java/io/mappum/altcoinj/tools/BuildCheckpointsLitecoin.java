...
import io.mappum.altcoinj.params.LitecoinMainNetParams;
 ...
 */
public class BuildCheckpointsLitecoin {
    ...
    public static void main(String[] args) throws Exception {
        ...
        chain.addListener(new AbstractBlockChainListener() {
            ...
            public void notifyNewBestBlock(StoredBlock block) throws VerificationException {
                int height = block.getHeight() + PARAMS.getIntervalOffset(block.getHeight());
                int m = height % PARAMS.getInterval(height);
                if (height > 1 && (m == 0 || m == 1) && block.getHeader().getTimeSeconds() <= oneMonthAgo) {
